use nyxs_owl::forecasting::strategies::{ExponentialSmoothingStrategy, ExponentialSmoothingConfig};
...
fn main() -> Result<()> {
    ...
    let configs = vec![
        ("Simple", ExponentialSmoothingConfig { alpha: 0.3, beta: None, gamma: None, ..Default::default() }),
        ("Holt", ExponentialSmoothingConfig { alpha: 0.3, beta: Some(0.1), gamma: None, ..Default::default() }),
        ("Holt-Winters", ExponentialSmoothingConfig { alpha: 0.3, beta: Some(0.1), gamma: Some(0.1), ..Default::default() }),
    ];
