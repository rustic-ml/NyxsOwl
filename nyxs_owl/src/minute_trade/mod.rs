...
///
/// This function generates realistic-looking OHLCV data for testing purposes.
/// The data includes price variations based on sine waves to simulate market movement.
