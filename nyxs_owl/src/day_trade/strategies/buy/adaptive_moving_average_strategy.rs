...
use crate::trade_math::moving_averages::SimpleMovingAverage;
use crate::trade_math::volatility::AverageTrueRange;
...
impl Default for AdaptiveMovingAverageStrategy {
